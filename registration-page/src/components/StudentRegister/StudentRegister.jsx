        ...
        <td>
          <table>
            ...
            <tr>
              ...
              <td>Class X</td>
              <td>
                <input type="text" name="ClassX_Board" maxlength="10" />
              </td>
              <td>
                <input type="text" name="ClassX_Percentage" maxlength="10" />
              </td>
              <td>
                <input type="text" name="ClassX_YrOfPassing" maxlength="10" />
              </td>
            </tr>
...
<input type="reset" value="Reset">
      ...
      <table />
      <div class="formInput">
        <label for="Verification" class="checky">
          Verification
        </label>
        <label class="checkbox">
          <input type="checkbox" />
          <span class="overlay">
            {/* <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
